...
function DateSelect(props) {
    ...
    return (
        <div className="rounded-xl flex w-4/6 bg-white mx-auto my-6 items-stretch justify-evenly px-12">
            {dates.map(date =>
                <div onClick={() => ChangeDate(date)}
                    ...
                    "be-vietnam-pro-bold text-2xl justify-center flex items-center rounded-3xl aspect-square w-[14.29%]"}
