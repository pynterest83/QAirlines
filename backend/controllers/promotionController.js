...
exports.createPromotion = async (req, res) => {
    try {
        ...
        return res.status(500).json({ error: 'An error occurred while creating the promotion' });
    }
};
...
exports.getPromotions = async (req, res) => {
    try {
        ...
        return res.status(500).json({ error: 'An error occurred while fetching the promotions' });
    }
};
